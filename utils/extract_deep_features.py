...
extract_vit_features(os.path.join(DATASET_DIR, "real"), os.path.join(OUTPUT_DIR, "real_vit.npy"))
extract_vit_features(os.path.join(DATASET_DIR, "fake"), os.path.join(OUTPUT_DIR, "fake_vit.npy"))
